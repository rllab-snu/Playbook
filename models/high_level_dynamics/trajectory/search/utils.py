...
def make_goalprefix(discretizer, goal):
    goal_dim = goal.size
    goal_discrete = discretizer.discretize(goal, subslice=[0, goal_dim])
    goal_discrete = to_torch(goal_discrete, dtype=torch.long)
    return goal_discrete
